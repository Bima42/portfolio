...
![Grafana Explore showing logs from the Ophio backend service](./resources/explore_plg.png)
...
![Grafana Dashboard showing logs for Ophio services](./resources/dashboard_plg.png)
