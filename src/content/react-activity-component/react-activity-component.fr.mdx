...
|----------|-----------|-----|
| Modals avec des formulaires | ****OUI**** | Le contenu brouillon survit au close/reopen |
| Sections secondaires de page (commentaires, sidebars) | ****OUI**** | Déprioritise l'hydration |
| Contenu qui ne devrait jamais render avant d'être nécessaire | ****NON**** | Utilisez le lazy loading ou le conditional rendering à la place |
| Animations ou transitions | ****NON**** | Utilisez CSS ou des librairies d'animation |
