...
|----------|-----------|-----|
| Modals with forms | ✅ | Draft content survives close/reopen |
| Secondary page sections (comments, sidebars) | ✅ | Deprioritizes hydration |
| Content that should never render until needed | ❌ | Use lazy loading or conditional rendering instead |
| Animations or transitions | ❌ | Use CSS or animation libraries |
